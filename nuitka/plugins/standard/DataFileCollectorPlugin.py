...
class NuitkaPluginDataFileCollector(NuitkaPluginBase):
    ...
    KnowDataFileDesc = collections.namedtuple(
        "KnowDataFileDesc", ("dest_path", "filename_pattern")
    )
    ...
    known_data_files = {
        ...
        # directory
        "botocore": (KnowDataFileDesc(filename_pattern="cacert.pem", dest_path=None),),
        "site": (KnowDataFileDesc(filename_pattern="orig-prefix.txt", dest_path=None),),
        "nose.core": (KnowDataFileDesc(filename_pattern="usage.txt", dest_path=None),),
        "scrapy": (KnowDataFileDesc(filename_pattern="VERSION", dest_path=None),),
        "dask": (KnowDataFileDesc(filename_pattern="dask.yaml", dest_path=""),),
        "cairocffi": (KnowDataFileDesc(filename_pattern="VERSION", dest_path=None),),
        "cairosvg": (KnowDataFileDesc(filename_pattern="VERSION", dest_path=None),),
        "weasyprint": (KnowDataFileDesc(filename_pattern="VERSION", dest_path=None),),
        "tinycss2": (KnowDataFileDesc(filename_pattern="VERSION", dest_path=None),),
        "certifi": (KnowDataFileDesc(filename_pattern="cacert.pem", dest_path=None),),
        "importlib_resources": (
            KnowDataFileDesc(filename_pattern="version.txt", dest_path=None),
        ),
        "moto": (
            KnowDataFileDesc(
        ...
        "tzdata": (KnowDataFileDesc(filename_pattern="zones", dest_path=None),),
        "lib2to3.pgen2": (
            KnowDataFileDesc(filename_pattern="../*.pickle", dest_path="lib2to3"),
        ),
    }
